...
public class Test {
    ...
    public static final String inputFile = new File(Environment.getExternalStorageDirectory(), "mkv.mkv").getAbsolutePath();
    ...
    public static  FFmpegApi  getTest2() {
        return new FFmpegApi(inputFile, outFile, "00:00:10", "00:01:01",null);
    }
