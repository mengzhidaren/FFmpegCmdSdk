...
#include <windows.h>
#endif
#define printf(fmt, ...) if(YYL_LOGCAT){yyl_print_log(fmt,## __VA_ARGS__);}
...
static void print_program_info(int flags, int level)
{
    ...
    av_log(NULL, level, "build date 2019.7.5 more info please see my github \n");
    av_log(NULL, level, "https://github.com/mengzhidaren\n");
}
